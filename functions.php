...
function doggos_scripts() {    
    ...
    wp_enqueue_style('rpg-awesome', get_stylesheet_directory_uri() . '/assets/fonts/Rpg-Awesome-master/css/rpg-awesome.min.css');
...
// Add required bootstrap classes to menus
...
// Adds the active class to the menu link for the current post
